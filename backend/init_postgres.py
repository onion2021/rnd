    ...
    try:
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS sub_activities (
                id SERIAL PRIMARY KEY,
                main_activity_id INTEGER REFERENCES main_activities(id),
                order_num INTEGER,
                doe_number VARCHAR(50),
                background TEXT,
...
def insert_activity_data():
    ...
    try:
        ...
        for activity in main_activities:
            ...
            main_activity_id = cursor.fetchone()[0]
            ...
            for sub_activity in sub_activities:
                cursor.execute(
                    """INSERT INTO sub_activities (main_activity_id, order_num, doe_number, background, activity_name, result) VALUES (%s, %s, %s, %s, %s, %s)""",
